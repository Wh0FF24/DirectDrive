...
# === Pointing Detection ===
POINTING_EXTENSION_THRESH = 0.55    # min arm extension ratio to count as pointing
...
# === Ground Target ===
GROUND_PLANE_Y = 50.0              # ground plane Y in camera frame (cm below camera)
GROUND_SMOOTH_ALPHA = 0.5          # EMA smoothing for ground target
ARRIVE_DISTANCE_CM = 30            # cm — consider "arrived" when this close

# === Navigation ===
NAV_DRIVE_SPEED = 40               # % throttle — slow and safe
